...
out1 = open("out1.txt","w",encoding="utf-8") 
...
# mots = open("etabliss.txt","r",encoding="utf-8") 
# texte = mots.read(386000000)
# texte=texte.split()
# for i in s:
#     if i not in texte:
...
# print(s)
# out2 = open("out2.txt","w",encoding="utf-8") 
...
print("##########################################################################################")
print("Stemming")
s1 = arabycia.stemming(text)
print(s1)
print("##########################################################################################")
print("Lemmatization")
s1 = arabycia.lemmatization(text)
print(s1)
print("##########################################################################################")
print("Segmentation")
s1 = arabycia.segmentation(text)
print(s1)

print("##########################################################################################")
print("stem")
s1 = arabycia.stem("اتفاق")
print(s1)
...
arabycia.set_raw_text(text)
search_result = arabycia.text_search("فكر") 
print(search_result)
...
# file = open("resultat.txt","r",encoding="utf-8") 
# text = file.read(386000000)
# doc=nlp(text)
# =============================================================================
# for token1 in doc:
